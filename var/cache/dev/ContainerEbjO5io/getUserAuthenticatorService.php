 ...
 */
class getUserAuthenticatorService extends App_Infra_Application_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Infra\Application\Security\UserAuthenticator' shared autowired service.
     *
     * @return \App\Infra\Application\Security\UserAuthenticator
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Infra/Application/Security/UserAuthenticator.php';

        return $container->privates['App\\Infra\\Application\\Security\\UserAuthenticator'] = new \App\Infra\Application\Security\UserAuthenticator(($container->services['doctrine.orm.default_entity_manager'] ?? $container->getDoctrine_Orm_DefaultEntityManagerService()), ($container->services['router'] ?? $container->getRouterService()), ($container->services['.container.private.security.csrf.token_manager'] ?? $container->get_Container_Private_Security_Csrf_TokenManagerService()), ($container->services['security.password_encoder'] ?? $container->load('getSecurity_PasswordEncoderService')));
    }
}
